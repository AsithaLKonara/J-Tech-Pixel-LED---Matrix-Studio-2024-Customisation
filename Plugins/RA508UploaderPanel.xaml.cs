...
{
    public partial class RA508UploaderPanel : UserControl
    {
        public RA508UploaderPanel()
        {
            InitializeComponent();
            DataContext = new RA508UploaderViewModel(UploadSnackbar);
        }
    }

    public class RA508UploaderViewModel : INotifyPropertyChanged
    {
        ...
        public RA508UploaderViewModel(Snackbar snackbar)
        {
