...
{
    public partial class ATMEGAUploaderPanel : UserControl
    {
        public ATMEGAUploaderPanel()
        {
            InitializeComponent();
            DataContext = new ATMEGAUploaderViewModel(UploadSnackbar);
        }
    }

    public class ATMEGAUploaderViewModel : INotifyPropertyChanged
    {
        ...
        public ATMEGAUploaderViewModel(Snackbar snackbar)
        {
        ...
        private async void Upload()
        {
            ...
            {
                _snackbarQueue?.Enqueue("Please enter a chip type (e.g., atmega328p).");
                return;
            }
