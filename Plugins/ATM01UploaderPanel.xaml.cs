...
namespace JTechPixelLED.Plugins
{
    public partial class ATM01UploaderPanel : UserControl
    {
        ...
        {
            InitializeComponent();
            DataContext = new ATM01UploaderViewModel(UploadSnackbar);
        }
    }

    public class ATM01UploaderViewModel : INotifyPropertyChanged
    {
        ...
        public ATM01UploaderViewModel(Snackbar snackbar)
        {
