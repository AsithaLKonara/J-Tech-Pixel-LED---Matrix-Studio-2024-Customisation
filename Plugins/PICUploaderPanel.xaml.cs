...
{
    public partial class PICUploaderPanel : UserControl
    {
        public PICUploaderPanel()
        {
            InitializeComponent();
            DataContext = new PICUploaderViewModel(UploadSnackbar);
        }
    }

    public class PICUploaderViewModel : INotifyPropertyChanged
    {
        ...
        private string chipType = "16F84A";
        ...
        public PICUploaderViewModel(Snackbar snackbar)
        {
        ...
        private async void Upload()
        {
            ...
            {
                _snackbarQueue?.Enqueue("Please enter a chip type (e.g., 16F84A).");
                return;
            }
            IsUploading = true;
