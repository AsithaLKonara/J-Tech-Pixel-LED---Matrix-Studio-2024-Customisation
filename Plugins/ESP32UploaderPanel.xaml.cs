...
{
    public partial class ESP32UploaderPanel : UserControl
    {
        public ESP32UploaderPanel()
        {
            InitializeComponent();
            DataContext = new ESP32UploaderViewModel(UploadSnackbar);
        }
    }

    public class ESP32UploaderViewModel : INotifyPropertyChanged
    {
        ...
        public ESP32UploaderViewModel(Snackbar snackbar)
        {
